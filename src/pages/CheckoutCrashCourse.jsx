...
const COURSE_NAME = "Duolingo 15 days crash course";
const COURSE_SLUG = "duolingo-15-days-crash-course";
...
export default function CheckoutCrashCourse() {
    ...
    return (
      <div className="mx-auto max-w-[860px] px-4 py-6 md:py-10">
        <SEO
          ...
          description="Checkout confirmation for DuoMate 15 days crash course."
          canonicalPath="/checkout/15-days"
  ...
  return (
    <div className="mx-auto max-w-[1180px] px-3 py-6 md:px-4 md:py-10">
      <SEO
        ...
        description="Checkout for DuoMate 15 days crash course. Complete your details and submit payment information."
        canonicalPath="/checkout/15-days"
        ogImage="https://www.duomatebd.com/og-image.png"
      />
