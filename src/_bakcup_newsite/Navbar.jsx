    ...
    <header className="sticky top-0 z-50 bg-neutral-200/70 backdrop-blur-md shadow-lg">
      <div className="flex w-full items-center justify-between gap-4">
        ...
        <nav className="hidden items-center gap-2 md:flex">
          ...
          <MenuLink to="/programs/duolingo">Duolingo</MenuLink>
        ...
        <div className="mr-8 flex items-center gap-3">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="hidden rounded-lg border border-slate-300 px-4 py-2 text-sm font-semibold text-slate-700 hover:bg-green-600 hover:text-white md:inline-flex"
          >
            Contact
          </a>
